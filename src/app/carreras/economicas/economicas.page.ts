...
@Component({
  selector: 'app-economicas',
  templateUrl: './economicas.page.html',
  styleUrls: ['./economicas.page.scss'],
})
export class EconomicasPage  {
  carreras: any;
  ...
  getAllStudents() {
    ...
    this.apiService.getListEconomicas().subscribe(response => {
